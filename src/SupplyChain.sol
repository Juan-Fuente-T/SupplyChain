...
/*
Los productos solo los puede crear un manufacturer. 
El only owner original evitaba que se moviese el producto de 
un dueño a otro si tu no eres el dueño en ese momento. Es decir, 
si el producto lo posee ahora 2 tiene que ser quien llame a la funcion
para que pase a 3.
*/
contract supplyChain {
    //Si comienzan en cero generan un pcoblema con el limite inferior de los input del front
