...
contract supplyChain {
    ...
    function addParticipant(string memory _name, string memory _pass, string memory _pType, address _pAdd) public returns (uint256){
    ...
    function addProduct(uint256 _productOwnerId,
    ...
    function newOwner(uint256 _user1Id,uint256 _user2Id, uint256 _prodId) public returns (bool) {
